...
create_clock -name audio_mclk -period 81.38 [get_ports audio_cons_mclk]  # 12.288 MHz
create_clock -name audio_bclk -period 325.52 [get_ports audio_I2S_bclk]  # 3.072 MHz
